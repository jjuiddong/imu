...
Quaternion2 q;           // [w, x, y, z]         quaternion container
...
void setup() {
    ...
    {
        std::cout << "udp init error" << std::endl;
    }
    ...
    // otherwise, check for DMP data ready interrupt (this should happen frequently)
        ...
        mpu.getFIFOBytes(fifoBuffer, packetSize);
            ...
            printf("ypr  %7.2f %7.2f %7.2f    ", ypr[0] * 180/M_PI, ypr[1] * 180/M_PI, ypr[2] * 180/M_PI);
            {
                ...
                packet.InitWrite();
                packet << (float)(ypr[0] * 180/M_PI);
                packet << (float)(ypr[1] * 180/M_PI);
                packet << (float)(ypr[2] * 180/M_PI);
                packet.EndPack();
            ...
            //     packet << fifoBuffer[8];
            //     packet << fifoBuffer[9];
            //     packet << fifoBuffer[12];
            //     packet << fifoBuffer[13];                
            //     packet.EndPack();
            //     udpClient.Send(network2::SERVER_NETID, packet);
            // }       
            //~
